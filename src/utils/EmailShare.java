                    ...
                    public void run() {
                        ...
                        contacts.addActionListener(new ActionListener() {
                            ...
                            public void actionPerformed(ActionEvent evt) {
                                ...
                                if(image == null){
                                    f[0] = new ShareForm(contactsForm, "Send Email", "mohamedamine.mbarki@esprit.tn", toShare,
                                            new ActionListener() {

                                                public void actionPerformed(ActionEvent evt) {
                                                    String [] recieptents = new String[1];
                                                    recieptents[0] = "mohamedamine.mbarki@esprit.tn";
                                    ...
                                    f[0] = new ShareForm(contactsForm, "Send Email", "mohamedamine.mbarki@esprit.tn", toShare, image,
                                            new ActionListener() {
